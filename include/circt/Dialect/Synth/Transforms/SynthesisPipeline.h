...
struct CombLoweringPipelineOptions
  ...
  PassOptions::Option<bool> disableDatapath{
      *this, "disable-datapath",
      ...
      llvm::cl::init(false)};
  PassOptions::Option<bool> verifiedDatapath{
      *this, "verified-datapath",
      llvm::cl::desc("Lower comb.mul/comb.add through formally verified "
                     "compressor trees generated by the Lean datapath-cli "
                     "tool instead of the Datapath dialect"),
      llvm::cl::init(false)};
  PassOptions::Option<std::string> verifiedDatapathLeanExe{
      *this, "verified-datapath-lean-exe",
