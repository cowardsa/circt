//===- ReplicateAdds.cpp - Replicate adds to fold -------------------*- C++
//-*-===//
//
...
namespace circt {
namespace datapath {
#define GEN_PASS_DEF_DATAPATHREPLICATEADDS
...
namespace {
struct DatapathReplicateAddsPass
    : public circt::datapath::impl::DatapathReplicateAddsBase<
          DatapathReplicateAddsPass> {
...
std::unique_ptr<mlir::Pass> circt::datapath::createDatapathReplicateAddsPass() {
  return std::make_unique<DatapathReplicateAddsPass>();
}
